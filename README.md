...
| frontend-slides           | <https://skills.sh/affaan-m/everything-claude-code/frontend-slides>                    | Helps create frontend-focused slide content for demos, presentations, and visual storytelling.                |
